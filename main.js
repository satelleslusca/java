...
// let valor2=parseInt(prompt('Digite o seu segundo número'));
// let valor3=parseInt(prompt('Digite o seu terceiro número'));
...
if (idade>17){
console.log(alert('Cadê a carteira de trabalho?'))
}
else{
console.log(alert('Já devia estar no job'))
}
for (let i = 0;  < estado.length; i++) {
    console.log(estados[i]);
}